      ...
      <div style="background:#fff;border-radius:20px 20px 0 0;width:100%;max-width:480px;padding:0 0 32px">
        ...
        <div style="padding:0 16px">
          <div style="text-align:center;padding:20px 0 16px;border-bottom:1px solid #f1f5f9;margin-bottom:16px">
            <div style="width:64px;height:64px;margin:0 auto 10px;background:linear-gradient(135deg,#2563eb,#16a34a);border-radius:18px;display:flex;align-items:center;justify-content:center;font-size:32px;box-shadow:0 6px 20px rgba(37,99,235,.25)">🏓</div>
            <div style="font-size:18px;font-weight:900;color:#1e293b">App Escuela de Pádel</div>
            <div style="display:inline-block;margin-top:6px;background:#eff6ff;color:#2563eb;border-radius:8px;padding:2px 12px;font-size:11px;font-weight:900">v1.17</div>
          </div>
          ...
          <div style="display:flex;align-items:center;gap:11px;padding:11px 0;border-bottom:1px solid #f8fafc">
            <div style="width:34px;height:34px;border-radius:9px;background:#f0fdf4;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0">📍</div>
            <div>
              <div style="font-size:10px;font-weight:900;color:#94a3b8;text-transform:uppercase;letter-spacing:.4px">Club</div>
              <div style="font-size:13px;font-weight:800;color:#1e293b">Club Tomares / Ayto. Tomares · Sevilla</div>
            </div>
          </div>
          <div style="display:flex;align-items:center;gap:11px;padding:11px 0;border-bottom:1px solid #f8fafc">
            ...
            <div>
              <div style="font-size:10px;font-weight:900;color:#94a3b8;text-transform:uppercase;letter-spacing:.4px">Última actualización</div>
              <div style="font-size:13px;font-weight:800;color:#1e293b">Marzo 2026</div>
            </div>
          </div>
